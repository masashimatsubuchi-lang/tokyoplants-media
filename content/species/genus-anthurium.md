...
「キング・アンスリウム」と呼ばれる大型の葉もの種。波打つ葉の表面は独特の光沢があり、成熟時には1.5〜2mを超えることも珍しくない。成長は遅いが、成熟した株の迫力は圧倒的。

### 主な品種の比較

| 品種 | タイプ | 葉の特徴 | サイズ |
|------|--------|----------|--------|
| アンドレアナム系 | 花もの | 光沢のあるハート型葉、仏炎苞の色が豊富 | 中型 |
| クラリネルビウム | 葉もの | ダークグリーンに銀白の葉脈、ビロード質 | 中型 |
| クリスタリナム | 葉もの | クラリネルビウムに似るがより大型・薄く光沢あり | 中〜大型 |
| ワロクアーナム | 葉もの | 細長い剣状の葉、長さ1m以上 | 大型 |
| フォルゲティー | 葉もの | 丸みを帯びた盾状の葉、シルバーの模様 | 小型 |
| ベイチー | 葉もの | 波打つ光沢のある大型葉、長さ1.5〜2m超 | 大型 |
...
<!-- character-note character="kuro" type="point" -->
着生植物の根は、土の中の「水」より「空気」を優先して探す性質があるよ。だから一般的な観葉植物より粗めの粒を選ぶのは、水はけだけでなく根に呼吸させるための工夫でもあるんだ。
<!-- /character-note -->
...
アンスリウムを選ぶ際は、「花を楽しみたいか、葉を楽しみたいか」で方向性が変わる。

### 花ものタイプ（フラワーアンスリウム）

アンドレアナム系のハイブリッドが主体。管理のしやすさと開花の容易さが最大のメリット。仏炎苞の色を複数そろえてコレクションするスタイルも人気。比較的安価で手に入れやすい。

### 葉ものタイプ（ベルベットアンスリウム・コレクター品種）

クラリネルビウム、クリスタリナム、ワロクアーナムなどが代表。葉の質感・葉脈模様・サイズが観賞の主役で、希少品種はコレクター市場で高額になることも多い。花ものより栽培難易度がやや高く、高湿度の管理が欠かせない。
...
アンスリウムの繁殖は株分けが最も安定しており、一般家庭でも実施しやすい。

### 株分け

成熟した株が複数の茎を出した場合、植え替え時に丁寧に株分けする。根を傷めないよう丁寧にほぐし、切り口をシナモンや殺菌剤で処理してから植え付ける。5〜6月が適期。

### 茎挿し（挿し木）

気根が発達した茎を切り取り、バーク主体の培地に挿す。着生植物のため、通気性の高い培地が発根を促す。発根まで4〜6週間。

### 種まき

交配させた果実から種を取り出し、湿らせた培地に播く。発芽まで2〜4週間。実生からの栽培は時間がかかるが、新しい交配品種が生まれる楽しみがある。コレクター間での実生取引も盛んである。
