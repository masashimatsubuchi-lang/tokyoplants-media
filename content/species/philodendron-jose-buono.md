...
15℃を上回る暖かい室内であれば成長は継続しますが、ペースは大幅に落ちます。水やりは表土が完全に乾いてから2〜3日後を目安に与え、過湿を避けます。施肥は行いません。加湿器で湿度60〜75%を維持することで、葉縁の乾燥と葉の黄化を防ぎます。育成ライトを使用している場合は点灯時間を12〜14時間に維持し、光量が落ちる冬でも斑の発現を安定させます。
...
<div style="flex:6;background:#166534" title="グリーン部分 目安60%"></div>
<div style="flex:4;background:#f5f5f4" title="白色部分 目安40%"></div>
</div>
