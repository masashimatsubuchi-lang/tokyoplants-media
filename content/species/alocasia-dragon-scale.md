---
image: "https://images.unsplash.com/photo-1617693322135-13831d116f79?w=800&q=80"
...
1. <mark>**高湿度の維持が最優先。** ボルネオの林床に近い湿度60〜80%を保つことで、葉のコンディションが安定する。湿度が低い環境では葉が丸まったり、縁が枯れ込みやすい。</mark>
...
<div style="flex:3;background:#c2410c" title="赤玉土 30%"></div>
<div style="flex:3;background:#d4d4d8" title="パーライト 30%"></div>
<div style="flex:2;background:#78350f" title="ピートモス 20%"></div>
<div style="flex:2;background:#92400e" title="バーク堆肥 20%"></div>
</div>

赤玉土30%・パーライト30%・ピートモス20%・バーク堆肥20%という比率で、排水性を担う無機質（赤玉土＋パーライト）が全体の6割を占める配合になる。
...
市販の観葉植物用培養土をベースにする場合は、袋の表示だけでなく実際に握ってみて団子状に固まりすぎないかを確認すると、パーライトの追加量を判断しやすいよ。
<!-- /character-note -->
...
湿度計は「今の数値」しかわからないから、朝と夜で40%以上変動していないかを1週間くらい記録してみると、加湿が本当に足りているか判断しやすいよ。
<!-- /character-note -->
...
休眠中の球茎は見た目が変化しないぶん心配になりがちだけど、水やりの回数を増やして様子を見ようとするのは逆効果。触って硬さを確認する方が水を足すより確実な判断材料になるよ。
<!-- /character-note -->
