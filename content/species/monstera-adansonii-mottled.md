...
葉全体にランダムな白〜クリームの斑が広がるモンステラ・アダンソニー斑入りは、コレクター植物の中でも特に人気の高い品種だ。モットルド（Mottled）とマーブル（Marble）と呼ばれる2種類の斑パターンが存在し、斑を維持するための光管理が育て方の鍵となる。

---

## 結論

1. <mark>**アダンソニー斑入りの斑はキメラ変異——遺伝的に不安定で、同じ株でも葉ごとに異なる模様が展開する。** 組織培養での安定量産が難しいため価格が高く、斑の出方の予測不可能さがコレクター心をくすぐる。</mark>
2. **斑維持の最重要条件は「明るい間接光」。** 光不足になると光合成効率を上げるために緑細胞が優勢になり（リバージョン）、新葉が無地に近くなる。全緑葉が出たら早めに切り戻す。
3. **白斑部分は葉緑素がなく直射日光に非常に弱い。** 数時間の直射で即座に葉焼けする——レースカーテン越しの明るさに固定することが管理の基本。
...
<mark>**光不足はリバージョン（緑化）の主な原因。**</mark>斑入り株が暗い環境に置かれると、光合成効率を上げるために葉緑素の多い緑色の部分が優勢になり、新葉が無地に近くなっていきます。光不足を感じたら速やかに明るい場所へ移動させてください。
