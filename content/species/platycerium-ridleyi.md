...
| 項目 | リドレイ | コロナリウム | ビフルカツム | ウィリンキー |
|------|----------|-------------|-------------|-------------|
| 貯水葉 | 内側に巻き込み球状 | 上方に展開し王冠状 | 板状に広がる | 板状 |
| 胞子葉 | ほぼ垂直に直立 | 長く垂れ下がる | 下垂〜水平 | 銀白色で優雅に垂れる |
| 子株の出やすさ | ほぼ出ない（単頭性） | — | 旺盛に出る | 出る（株分け可） |
| 耐寒性 | 弱い（15℃以上必須） | 弱め | 比較的高い（個体差あり） | 弱め |
| 栽培難易度 | 上級者向け | 上級者向け（リドレイほど蒸れに敏感ではない） | 初心者向け | 中級者向け |
...
浸水させた直後の板付け株を一度持ち上げて重さを覚えておくといいよ。乾いてくると目に見えて軽くなるから、「そろそろ乾いたかな」の感覚が数字じゃなく手の感覚でつかめるようになる。
<!-- /character-note -->
...
水苔は乾くとキュッと締まって、湿っているときより通気性が良くなる性質があるよ。最初から詰め込みすぎず、少なめに入れて根の活着具合を見ながら足していくくらいがちょうどいい。
<!-- /character-note -->
...
球状に巻き込んだ貯水葉の内部は外から見えにくいから、気づいたときには進行しているケースが多いよ。定期的に軽く持ち上げて中の様子を覗いてみる習慣が、早期発見の一番の近道だよ。
<!-- /character-note -->
