...
ホヤ属は種数が多く、どれを選べばよいか迷いやすい。以下を参考に、経験レベルに合った品種から始めると失敗が少ない。

| 難易度 | 品種例 | 特徴 |
|--------|--------|------|
| 入門向け | カルノーサ、プビカリクス | 丈夫・開花しやすい |
| 中級向け | ケリー、カーティシー、オブスクラ | 成長はゆっくりだが安定して育てられる |
| 上級向け | リネアリス、インブリカータ | 温度・湿度の管理が求められる |

カルノーサは日本の気候でも屋外管理できる丈夫さを持ち、開花実績を積むのに最適な入門種である。慣れてきたら葉の形や質感がユニークな品種に挑戦するとコレクションの幅が広がる。

---

## 繁殖と増やし方

ホヤ属の繁殖は比較的容易で、成長期に行うと成功率が高い。

### 茎挿し（挿し木）

節を1〜2節含む茎を切り取り、カットした断面を1〜2日乾燥させてから清潔な培地（パーライト、バーライト等）または水に挿す。多肉質の葉に水分があるため乾燥にも耐え、発根まで3〜6週間。

### 水挿し

透明な容器に水を入れ、節が水に触れるよう挿す。明るい間接光の下で2〜4週間で発根する。根が2〜3cm伸びたら排水性の良い用土に移す。水から用土への移行期は特に過湿に注意する。

### 葉挿し（注意点あり）

ケリーなど肉厚な葉は葉単体でも発根するが、**葉だけでは株（茎・成長点）は形成されない**。流通している葉1枚挿しのケリーは観賞用と割り切るか、節付きのものを選ぶことが大切。
