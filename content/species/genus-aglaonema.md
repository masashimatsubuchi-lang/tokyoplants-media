...
属名 *Aglaonema* はギリシャ語の "aglaos"（輝く）と "nema"（糸）を組み合わせた造語で、雄蕊の花糸が光沢を持つことに由来する。1829年にオーストリアの植物学者Heinrich Wilhelm Schottが記載した。
...
アグラオネマの品種は大きく「クラシック系」と「タイカラー系」に分けられる。

### クラシック系（グリーン・シルバー）

原種に近い緑とシルバーの葉色。代表品種はシルバークイーン、シルバーベイ、マリア。耐陰性が極めて高く、低光量環境に最も適する。オフィスや廊下などの照明のみの環境でも安定して育てられる。

### タイカラー系（赤・ピンク・オレンジ）

タイで品種改良された鮮やかな葉色品種。バレンタイン、レッドサム、コチンなどが代表。鮮やかな発色には明るい間接光が必要で、暗い環境では色が落ちる。育種が活発で新品種が毎年リリースされる。

葉の斑入りパターンが似た品種同士は区別が難しいため、**流通名（品種名）を記録して管理する**のがコレクションを楽しむコツである。

---

## 繁殖と増やし方

アグラオネマは比較的増やしやすく、以下の方法が一般的である。

### 株分け

叢生する株が大きくなったら、根元から複数の茎を分けて株分けできる。5〜6月の植え替え時に同時に行うのが効率的。切り口を殺菌してから植えると病気予防になる。

### 茎挿し（挿し木）

下葉が落ちて茎が伸びた株を再生させるのに有効。茎を10〜15cm切り取り、1〜2日乾燥させてから培地または水に挿す。発根まで3〜5週間。発根後は排水性の良い用土に移す。

### 茎の切り戻し

切り戻した親株の茎からも新芽が出る。上部は挿し木に利用でき、下部も脇芽を展開するため、切り戻しは一石二鳥の更新方法になる。
