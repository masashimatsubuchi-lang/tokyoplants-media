...
大きなしずく型の光沢ある葉が特徴。直立型で、葉の形がレインドロップ（雨粒）に例えられる。ペペロミアの中では大型で、存在感がある。詳しい特徴と育て方は[ペペロミア・ポリボトリアの育て方｜しずく型の葉が美しいレインドロップ](/species/peperomia-polybotrya)で解説している。
...
ペペロミアは挿し木による増殖が非常に容易な属で、初心者でも高い成功率が期待できる。

**茎挿し：** 健全な茎を2〜3節で切り取り、切り口を2〜3日間乾燥させる。その後、湿らせたパーライトや水苔、または多肉植物用の乾き気味の土に挿す。発根まで2〜4週間が目安。茎が太い直立型品種（オブツシフォリアなど）に適している。

**葉挿し：** カペラータなど、葉の質感が厚い品種は葉挿しでも増やせる。葉を葉柄ごと切り取り、切り口を乾燥させてから土に挿す。発根と新芽の出現まで時間がかかる（1〜3ヶ月）が、葉を剪定するついでに試せる手軽さが魅力。

**注意点：** 発根前の挿し穂に過剰な水やりをすると腐敗する。土が完全に乾かない程度に最小限の水やりにとどめ、明るい間接光の下で管理する。ビニール袋をかぶせて湿度を保つ方法も有効だが、蒸れに注意する。

---

## 小さな鉢でのコレクション栽培

ペペロミアは小型種が多く、3号〜5号（直径9〜15cm）の鉢でコンパクトに管理できる。葉の形状・質感・色がそれぞれ全く異なるため、複数品種を集めてコレクションとして楽しむ育て方が人気を集めている。

棚一段にさまざまな葉質のペペロミアを並べると、テクスチャーのバリエーションで視覚的なメリハリが生まれる。光沢のあるオブツシフォリア、深いシワのカペラータ、スイカ模様のアルギレイア、ミニマルな丸葉のホープと並べると、同じ属でありながら驚くほど表情が異なる。

水やりの頻度がほぼ同じで、温度・光条件も共通しているため、まとめて管理しやすい点もコレクション向きの理由のひとつである。小さなサイズのまま維持しやすく、置き場所を選ばない点も魅力だ。
