...
室内で穴の開いた葉があまり出ないのは、単に「まだ若い」だけでなく、木漏れ日のようなムラのある光環境を再現できていないサインでもあるよ。窓際でも置き場所を少し変えるだけで印象が変わることがある。
<!-- /character-note -->
...
「観葉植物は水のやりすぎに注意」という一般論をそのまま当てはめると、モンステラ・デリシオーサでは逆に水切れを見逃しやすくなるよ。大きな葉ほど蒸散量が多いことを頭に入れて、夏場はこまめに土をチェックしてね。
<!-- /character-note -->
...
支柱を立てても、そもそもの置き場所が暗いとフェネストレーションは進みにくい。アプリの光量チェック機能で今の場所の明るさを一度数値で確認してから、支柱を立てる位置を決めるのもおすすめだよ。
<!-- /character-note -->
