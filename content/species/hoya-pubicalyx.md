---
image: "https://images.unsplash.com/photo-1735115642558-64c9a978427b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=1080"
...
1. <mark>**ピュービカリックス最大の魅力は「ダークレッド〜漆黒に近いベルベット状の花」——シルバースプラッシュ斑の葉と組み合わさる暗色の花序は、他のホヤ属種では得難い独特のコントラストを生む。** 花柄（ペドゥンクル）を絶対に切らないことが、継続的な開花を楽しむ唯一の鉄則。</mark>
2. **根詰まりさせることが開花のトリガーになる。** 鉢いっぱいに根が張るほど開花スイッチが入りやすく、植え替えのタイミングは「根が溢れてから」が正解。あえて小さめの鉢を維持することで開花頻度が上がる。
3. **乾燥気味の管理と高通気が根腐れを防ぐ絶対条件。** 着生植物として根への酸素供給を優先し、培地表面が乾いてから数日後に水を与えるサイクルを厳守する。
...
カルノーサより水を欲しがる分、乾くペースも株ごとに差が出やすいよ。「何日おき」と決めつけるより、水やりした日をアプリなどで記録しておくと、その株なりの乾くペースがつかみやすくなるんだ。
<!-- /character-note -->
...
根が伸びる余地がなくなると、株は「これ以上体を大きくするより、子孫を残す方にエネルギーを使おう」というスイッチが入りやすくなるんだ。大きな鉢でのびのび育てたい気持ちをぐっとこらえるのが、開花への近道だよ。
<!-- /character-note -->
...
花が終わったあとの花柄は見た目が地味だから、ついお手入れのつもりで切りたくなるんだよね。でもホヤにとってはそこが「来年の花のための蕾を出す場所」だから、枯れ枝と間違えて切らないよう覚えておいて。
<!-- /character-note -->
...
着生植物は「乾燥に強い＝多少多湿でも平気」だと誤解されがちだけど、根が空気を好む性質は変わらないよ。水やり前に必ず培地の中まで乾いているか指で確認する習慣が、根腐れの一番の予防になるんだ。
<!-- /character-note -->
