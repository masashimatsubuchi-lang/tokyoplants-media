...
モンステラ属（*Monstera*）はサトイモ科に属する常緑つる性植物のグループで、73種が中央アメリカから南アメリカの熱帯雨林に自生している（Kew Plants of the World Online調べ。詳細は[モンステラ属 全種一覧](/research/monstera-species-list)を参照）。大きく切れ込みの入った葉が最大の特徴で、観葉植物として世界中で広く栽培される。
...
気根は「見た目が気になるから切る」という人も多いけど、実は自然界では樹木にしがみついて上へ登るためのロープの役割をしているんだ。支柱に絡めてあげると、本来の生態に近い育ち方をしてくれるよ。
<!-- /character-note -->
...
モンステラ属は根の張りが旺盛だから、排水性の低い土のまま何年も植え替えないと、根が呼吸できずに黄葉・根腐れが一気に進むよ。1〜2年に1回の土の更新を忘れずに。
<!-- /character-note -->
...
デリシオーサとボルシギアナの区別は特に混乱しやすい。葉のサイズと節間の長さ、また成熟葉の**葉柄基部にゼニタナゴ状の耳（auricle）があるかどうか**が判別点になる。デリシオーサには耳があり、ボルシギアナにはない、というのが一般的な識別基準とされる。

<!-- character-note character="lum" type="tip" -->
似た品種の見分けは写真だけだと難しいから、アプリの図鑑機能で自分の株の特徴を記録しておくと、後で見返したときに品種判定の手がかりになるよ。
<!-- /character-note -->
...
- モンステラ属はサトイモ科の常緑つる性植物で、73種が熱帯アメリカに自生（POWO調べ）
- 葉の切れ込みと穴が属全体の共通特徴
