---
image: "https://images.unsplash.com/photo-1631413720460-b778100a3d2b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=1080"
...
1. <mark>**ヴェノム最大の魅力は「漆黒に近い葉色と白銀の葉脈の高コントラスト」——ダークカラー系アロカシアの中でも葉の黒みが際立ち、光が当たるほど葉脈の輝きが強調される。** 交配品種ならではの強健さも兼ね備え、ジュエルアロカシアの中では比較的育てやすい部類に入る。</mark>
2. **高湿度（60〜80%）が葉色の深さと葉脈コントラストを最大化する。** 湿度不足では葉先が傷み、黒みが薄れてダークカラーの魅力が失われる。加湿器と霧吹きの併用が効果的。
3. **水苔単植えと適切な水やり頻度が根腐れ防止の基本。** アロカシア属全般に共通する「過湿に弱い」特性を理解した上で管理し、成長期は積極的に水を与えながら鉢内の乾燥と通気を確保する。
...
まず管理条件の全体像を1枚にまとめます。個々の理由は以下の各項目で補足します。

| 項目 | 目安 | 押さえるポイント |
|------|------|------------------|
| 光 | 明るい間接光（1,000〜3,000 lux） | 直射日光は葉焼け＋退色の原因。光量不足では黒みが薄れて普通の緑に近づく |
| 温度 | 18〜30℃ | 15℃以下で生育停止、10℃以下で株が傷む。35℃超の高温も負担 |
| **湿度** | **60〜80%（最重要）** | **一般的な室内（40〜50%）では葉先・葉縁が枯れ込む。加湿器が主役、葉水は補助** |
| 水やり | 表土が乾いたらたっぷり（冬は夏の半分以下の頻度） | 受け皿の水はすぐ捨てる。「土が湿っているうちはやらない」を徹底 |
| 用土 | 水はけ重視。無機系培地（溶岩石×ゼオライト）が有効 | 有機土より根腐れリスクを下げられる |
| 肥料 | 生育期（4〜9月）に月1〜2回、液体肥料を規定量の半量 | 休眠期（10〜3月）は施肥を停止 |
| 植え替え | 生育期（5〜8月）に一回り大きな鉢へ | 根詰まりは生育停滞・新葉が出ない原因になる |
...
照度計を持っていなくても、スマホのカメラで明るさをlux換算できるアプリの光チェック機能を使えば、置き場所が適正範囲に入っているか手軽に確認できるよ。感覚だけで判断するより、数値で見た方が黒みの変化に気づきやすいんだ。
<!-- /character-note -->

### 湿度管理（最重要）

<mark>ヴェノムの管理において湿度は最も重要なファクターのひとつです。</mark>**湿度60〜80%**を維持することを目標にしてください。

湿度帯ごとに、株に起きることは次のように変わります。

<div style="margin:1.5rem 0">
<p style="margin:0 0 6px;font-size:12px;color:#57534e">室内湿度とヴェノムの状態（左＝乾燥／右＝適正）</p>
<div style="display:flex;flex-wrap:wrap;height:22px;border-radius:0.375rem;overflow:hidden">
<div style="flex:5;min-width:24px;background:#b91c1c"></div>
<div style="flex:1;min-width:24px;background:#d97706"></div>
<div style="flex:2;min-width:24px;background:#15803d"></div>
</div>
<p style="margin:0.75rem 0 0;font-size:11px;color:#57534e"><span style="color:#b91c1c">■</span>〜50%：一般的な室内。葉先・葉縁が枯れ込みやすい　<span style="color:#d97706">■</span>50〜60%：目標未達。加湿の上積みが必要　<span style="color:#15803d">■</span>60〜80%：適正域</p>
</div>
...
葉水は「湿度を底上げする補助」であって「湿度を維持する主役」じゃないんだ。葉水だけで満足してしまうと、実際の湿度は40%台のままということも多いから、加湿器や湿度計で数値を確認する習慣をつけてね。
<!-- /character-note -->
...
「高湿度を保ちたい」と「根を過湿にしたくない」は、実は両立させないといけない別の条件なんだ。空気中の湿度は高くても、土の中はちゃんと乾湿のメリハリをつけてあげるのがヴェノムを長く楽しむコツだよ。
<!-- /character-note -->
...
症状から原因の当たりをつけるための一覧です。まず下表で候補を絞り、詳細は各項目を読んでください。

| 症状 | 最有力の原因 | 最初にやること | 関連記事 |
|------|--------------|----------------|----------|
| 黒色が薄くなってきた | 光が強すぎる・直射日光が当たっている | 間接光のみになる場所へ移動（判定は次の新葉で） | [アロカシアの育て方完全ガイド](/guide/alocasia-care-guide) |
| 葉先・葉縁が茶色く枯れる | 乾燥・低湿度（エアコンの直風も） | 加湿器を稼働し、風が当たらない位置へ移動 | [アロカシアの夏越し](/guide/alocasia-summer-care) |
| 葉が急に萎れる・黄変する | 根腐れ（過湿・水はけの悪い用土） | 鉢から抜いて根の腐敗を確認し、腐敗根を除去 | [アロカシアが根腐れする原因と対処法](/guide/alocasia-root-rot-treatment) |
| 生育が極端に遅い・新葉が出ない | 低温（15℃以下）または根詰まり | まず18℃以上を確保。根詰まりなら生育期に植え替え | [アロカシアの植え替え方法](/guide/alocasia-repotting-guide) |
| 葉に黄色い斑点・白い粉 | ハダニ・カイガラムシ（乾燥環境で多発） | 葉の表裏を水で洗い流し、湿度を60%以上へ | [アロカシアの育て方完全ガイド](/guide/alocasia-care-guide) |
