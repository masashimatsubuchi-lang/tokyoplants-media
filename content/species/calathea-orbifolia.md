...
新葉が展開している最中は、その株が一番デリケートな時期。展開が終わって葉が硬くなるまでは、いつも以上に湿度をキープしてあげるといいよ。
<!-- /character-note -->
...
汲み置き水は「一晩」でも十分だけど、できれば口の広い容器に入れて置くとカルキが抜けやすいよ。浄水器の水がある家ならそれが一番手軽。
<!-- /character-note -->

### 用土

保水性と排水性のバランスが重要です。市販の観葉植物用土に赤玉土小粒15%とパーライト10%を加えた配合が安定しています。

<div style="display:flex;height:20px;border-radius:0.375rem;overflow:hidden;margin:0.5rem 0">
<div style="flex:75;background:#6b4423" title="市販の観葉植物用土 75%"></div>
<div style="flex:15;background:#c97b3d" title="赤玉土(小粒) 15%"></div>
<div style="flex:10;background:#a8a29e" title="パーライト 10%"></div>
</div>
<p style="margin:0.25rem 0 0;font-size:12px;color:#78716c">市販の観葉植物用土75% ／ 赤玉土(小粒)15% ／ パーライト10%</p>

ピートモスを含む配合は保水性が高くなりすぎる場合があるため、ピートモス比率が高い用土の場合はパーライトを増量して調整します。鉢底石は必須ではありませんが、排水穴のある鉢を必ず使用します。具体的な配合比率や植え替え手順は[カラテアの土おすすめ｜配合レシピと植え替えで根腐れさせないコツ](/soil/best-soil-for-calathea)で詳しく紹介している。

<!-- character-note character="kuro" type="point" -->
このブレンドはあくまで市販の培養土をベースにした「足し算」の配合。ゼロから配合するならリンク先の赤玉土・腐葉土・パーライト・くん炭のレシピの方が、環境に合わせて微調整しやすいよ。
<!-- /character-note -->
