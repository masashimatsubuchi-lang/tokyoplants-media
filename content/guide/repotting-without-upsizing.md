...
<mark>通常の植え替えと同じく **5〜6月** がベストです。根をカットするため、回復力が最も高い時期に行ってください。</mark>
...
「同じ鉢に戻すから土も同じでいい」は根の回復を妨げる一番の落とし穴。いつ土を替えたかをアプリの植え替え記録に残しておくと、次の周期を判断しやすくなるよ。
<!-- /character-note -->
...
| 植物 | サイズ維持のコツ |
|------|----------------|
| モンステラ | 根のカットに加え、つるの剪定と気根の整理。切った茎は水挿しで増やせる |
| パキラ | 幹に水分を蓄えるため根カット後の回復が比較的速い。植え替え後の水やりは特に控えめに |
| ウンベラータ | 幹を好みの位置で切り戻すと切り口の下から分岐。根のカットと同時に幹も切り戻す |
| ポトス | つるを短く切り戻すだけで大幅にコンパクトに。根も1/3カットして問題なし |
| サンスベリア | 子株を株分けし、親株だけを同じ鉢に戻す |
