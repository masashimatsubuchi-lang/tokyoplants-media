...
amazonProducts:
  ...
  - title: "ARS(アルス) 剪定鋏 VS-8Z"
    asin: "B005Q4LU1I"
    note: "1876年創業・堺の刃物メーカー製。生木切断能力約15mmで根切りにも使いやすい。評価★4.5・レビュー1,561件（2026-09-07確認、在庫あり・Amazon.co.jp発送）"
    price: "¥3,220〜"
...
1876年創業、刃物の産地・堺（大阪府）に本社を置くARSコーポレーションの定番剪定鋏です。生木切断能力は約15mmで、観葉植物の根や茎のカットには十分な性能。評価★4.5・レビュー1,561件（確認済み）と、剪定ばさみカテゴリの中でも特に実績のある商品です。
