...
出発前の水やりをした日付って、旅行から帰ってから「結局いつあげたっけ」と忘れがちなんだよね。水やり記録をアプリにつけておくと、留守にした日数と照らし合わせて判断しやすくなるよ。
<!-- /character-note -->
...
受け皿給水は便利だけど、あくまで「留守中だけの応急処置」だよ。帰宅したらすぐに水を捨てて、常設の管理方法にはしないでね。長期間浸けっぱなしにすると根が呼吸できなくなってしまうよ。
<!-- /character-note -->
...
| 方法 | コスト | 有効期間の目安 | 適している植物 | 注意点 |
|---|---|---|---|---|
| ペットボトル自動水やり | 0円 | 500mlで3日／1Lで5日程度 | モンステラ・フィロデンドロン・ポトスなど | 穴の数で流量が変わるため事前に試す |
| 受け皿給水 | 0〜数百円 | 設置している間は継続 | モンステラ・フィロデンドロン・アンスリウム・アロカシアなど | 根腐れしやすい植物（サンスベリア等）には不向き |
| ビニール袋で簡易温室 | 0円 | 4〜6日程度 | 直射日光の当たらない場所に置く植物全般 | 直射日光下は厳禁（蒸れて枯れる） |
...
| グッズ | 値段 | 有効期間 | メリット | デメリット |
|---|---|---|---|---|
| 陶器製の水やりコーン | 1,000〜3,000円（1本） | 7〜10日程度（1L入り） | 手軽・見た目もおしゃれ・繰り返し使える | 1本あたりの対応鉢数が少ない |
| タイマー式水やり機 | 3,000〜8,000円 | タンク容量次第（10L以上なら2週間以上） | 複数の鉢をまとめてケアできる・日常使いも可能 | 初期費用がかかる・設置と調整に時間が必要 |
| スポンジ毛細管給水（DIY） | 0〜500円 | 10L程度の水で7〜10日 | コストが非常に安い | セッティングに工夫が必要・高低差で水量が変わる |
...
無機培地は「水を減らす工夫」じゃなくて「根が過湿でも呼吸できる環境」を作る工夫なんだ。だから旅行中に水が多めに残っていても、根腐れが起きにくいのが土植えとの根本的な違いだよ。
<!-- /character-note -->
