...
葉が落ちる原因のほとんどは「時期のミス」と「植え替え後の環境変化」です。逆にいえば、適切な時期に正しい手順で植え替えを行えば、ウンベラータはほとんど葉を落とさずにスムーズに新環境へ移行できます。なお、植え替えと無関係に葉が落ちている場合（冬の寒さ・夏の水切れなど）は、[ウンベラータの育て方｜葉が落ちる原因と対策](/guide/umbellata-care)の診断表で原因を先に確認してください。
...
「成長期に入った直後」がミソ。真夏になると根はもう暑さへの対応で手一杯だから、植え替えの負担まで乗せると回復が追いつかなくなりやすいんだ。
<!-- /character-note -->
...
<!-- comparison-summary
  title="植え替えてOKなタイミング／避けるべきタイミング"
  leftLabel="植え替えてOK"
  leftTagline="根が回復しやすいタイミング"
  leftItems="5〜6月の成長期|購入・環境変化から2〜4週間以上経過して落ち着いている|根腐れが疑われる場合（季節を問わず緊急対応）"
  rightLabel="植え替えはNG"
  rightTagline="根がダメージから回復しにくいタイミング"
  rightItems="購入直後・引っ越しや模様替えの直後|11〜3月の休眠期|根腐れ以外の体調不良・病害中"
-->
...
根を水で洗い流したくなる気持ちはわかるけど、ウンベラータのようなデリケートな根は洗浄自体がストレスになる。土を落とすのは手でほぐす程度にとどめよう。
<!-- /character-note -->
...
土やりを我慢する代わりに葉水で乾燥をケアするのがポイント。根が動き出すまでは「土は乾かし気味、葉は湿らせる」で覚えておくといいよ。
<!-- /character-note -->
...
この手順を丁寧に守ることで、ウンベラータは葉をほとんど落とさずに新しい鉢へ順応していきます。植え替えに使う土の条件と配合レシピは[ウンベラータの土おすすめと配合レシピ](/soil/best-soil-for-umbellata)、日常の水やり・肥料・剪定・増やし方は[ウンベラータの育て方](/guide/umbellata-care)をあわせて参考にしてください。大きなハート形の葉を元気に広げるウンベラータのために、ぜひ適切なタイミングで植え替えにチャレンジしてみてください。
