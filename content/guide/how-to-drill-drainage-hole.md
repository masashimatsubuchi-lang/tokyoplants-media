...
排水穴があるかどうかは、見た目以上に根の健康を左右するポイントなんだ。土の配合をどんなに工夫しても、水の逃げ場がなければ意味が薄れちゃうから、鉢選びの段階で最初にチェックしたい部分だよ。
<!-- /character-note -->
...
穴なし鉢の水やりって、頭の中で「今日は何ml」と計算しながらやる感じになりがちなんだよね。穴を開けてしまえば「鉢底から流れるまでたっぷり」というシンプルな基準に戻せるから、日々の水やりの負担がぐっと軽くなるよ。
<!-- /character-note -->
...
穴あけに自信がないときは、まず使わなくなった小さな鉢で1回練習してから本番に臨むと安心だよ。角度と力加減の感覚さえ掴めれば、次からは怖くなくなるはず。
<!-- /character-note -->
...
<!-- comparison-summary
  title="自分で開ける vs 専門店に依頼、どっちを選ぶ？"
  leftLabel="自分で開ける"
  leftTagline="道具と手順があれば十分可能"
  leftItems="プラスチック・コンクリートなど割れにくい素材の鉢|安価な鉢や練習用の鉢で試したい人|電動ドリル・ダイヤモンドビットを揃えられる人"
  rightLabel="専門店に依頼する"
  rightTagline="失敗できない鉢はプロに任せる"
  rightItems="ガラス製の鉢（割れると修復不可能）|一点物・高価な陶器・アンティーク鉢|電動工具を持っていない・扱いに不慣れな人"
-->
