...
<mark>**「1号UP（直径+3cm）」が最も安全な選択です。** 2号以上大きくすると、土の量が増えすぎて乾燥に時間がかかり、過湿→根腐れのリスクが上がります。</mark>
...
「大きい鉢に植えれば植え替えの頻度を減らせる」と考えがちだけど、根が土を使いきれない期間が長引くほど過湿のリスクも長く続くということ。鉢のサイズは根の量に合わせるのが基本だよ。
<!-- /character-note -->

### 適度な制限が根張りを促す

一般的に、根の先端が鉢の壁や底に当たると、そこから側根が発生して根量が増えるとされています。根鉢に対して適度にコンパクトな鉢は、この分岐を早い段階で促すため、結果的に根張りが密になりやすいと考えられています。

逆に大きすぎる鉢では、根が壁に届くまでに時間がかかって分岐が遅れ、根量が少ないまま過湿状態が続くという悪循環に陥りやすくなります。「大は小を兼ねる」は鉢選びには当てはまりません。
...
「1号UP」が基本とはいえ、根の張り具合によっては同じサイズの鉢に植え直すだけで十分なこともあります。鉢から抜いたときの根鉢の状態を目安にしてください。

| 根鉢の状態 | 判断 |
|-----------|------|
| 鉢底穴から根がはみ出している | サイズアップの適期 |
| 根が鉢の形にびっしり回っている | 1号UPで植え替え |
| 根鉢を崩すと土がぽろぽろ落ちる程度で、根に余裕がある | 同サイズでも可（土の入れ替えのみ） |

2号以上のサイズアップが必要になるケースはほとんどありません。大型に育てたい場合でも、1号ずつ段階的に大きくしていくほうが、結果的に健全な成長につながります。
...
素焼き鉢に植え替えたら、以前と同じ水やり頻度だと乾かしすぎになることがあるよ。植え替え直後の数週間は土の乾き具合をこまめにチェックして、新しいペースを見つけてあげて。
<!-- /character-note -->
...
おしゃれな鉢ほど底穴がないデザインが多いから要注意。見た目に一目惚れした鉢は、まず底穴の有無を確認する癖をつけてね。
<!-- /character-note -->
...
## すでに大きすぎる鉢に植えてしまった場合の対処

植え替え直後で再度植え直すのが難しい場合は、次の方法で過湿のリスクを抑えられます。

- **排水層を厚くする**：鉢底石を通常より多め（鉢の深さの1/4程度）に入れ、実質的な土の量を減らす
- **水やりの間隔を空ける**：土の表面が乾いてからさらに2〜3日待ってから与える。割り箸を土に挿して抜き、内部の湿り具合を確認する方法も有効
- **鉢の中に鉢を入れる**：適切なサイズの内鉢（スリット鉢など）に植え、それを大きな鉢にセットする。見た目を変えずに根域を制限できる

いずれも応急処置です。次の植え替え時期には、根鉢に合ったサイズの鉢に移してください。
...
「大きく育てたい」と3号→6号に植え替えるケース。土の量が4倍以上になり、過湿で根腐れします。必ず1号ずつサイズアップしてください。すでに植えてしまった場合は、上記「すでに大きすぎる鉢に植えてしまった場合の対処」を参考にしてください。
