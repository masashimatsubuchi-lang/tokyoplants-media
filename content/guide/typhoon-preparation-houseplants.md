...
台風の進路予報が出たら、以下をタイミング別に進めておきましょう。

| タイミング | やること |
|---|---|
| **数日前**（進路予報が出たら） | 避難先（玄関・廊下・浴室など）を確保する／鉢底の排水穴の詰まりを確認する／ベランダの排水口（ドレン）周りのゴミを取り除く／防風ネット・不織布・ロープ・重りを用意する |
| **前日まで** | 小〜中型の鉢植えを屋内へ避難させる（受け皿の水を捨て、葉裏の害虫を確認）／ハンギングポット・吊り鉢は必ず取り込む／動かせない大型鉢は横倒し・壁際集約・ロープや重りで固定する／支柱・行灯（あんどん）仕立ては支柱を補強するか倒して固定する／葉の広い植物を防風ネットや不織布で覆う |
| **当日** | 屋外での作業はしない（転倒・怪我の危険）。室内に避難させた鉢の様子を確認する程度にとどめる |
| **通過後** | 受け皿の水を捨てる／塩害・折れ枝・過湿の3点を点検する／葉に塩の跡があれば洗い流す |
...
まず手持ちの植物を「動かせるか」「どんな仕立てか」で整理すると、やるべき対策が見えてきます。

| 植物・鉢のタイプ | 基本方針 | 具体的な対応 |
|---|---|---|
| 小〜中型鉢（一人で持てる） | 屋内へ避難 | 玄関・廊下・浴室などへ前日までに移動。受け皿の水は捨てる |
| 大型鉢（持ち上げられない） | 固定・保護 | 横倒しにして壁際へ／ロープ・重りで固定／キャスター台で建物の陰へ |
| ハンギングポット・吊り鉢 | 必ず取り込む | 落下すると階下・通行人に危険。屋内避難が唯一の対策 |
| 支柱・行灯仕立て | 補強または倒して固定 | 支柱ごと風を受けやすい。無理に立たせない |
| 葉の大きい植物（モンステラ・ウンベラータ・バナナ類など） | 屋内避難＋ネット保護 | 屋内に入らない場合は防風ネット・不織布で鉢ごと覆う |
| 着生植物（ビカクシダの板付け・吊り） | 取り込む | 詳細は[ビカクシダの置き場所ガイド](/guide/platycerium-placement-guide)を参照 |
...
「玄関や浴室は暗いけど大丈夫？」とよく心配されるけど、数日なら光不足の影響より風で葉が裂けるダメージのほうがずっと大きいよ。避難を優先して、戻すときはいきなり強い日差しに当てず、元の場所に戻す前に半日陰で1日慣らすと安心。
<!-- /character-note -->
...
大型鉢の定位置を決めるときは、日当たりだけじゃなく「風の通り道」も一緒に見ておくのがコツ。ベランダの角や手すり際は風が集まりやすいから、普段から壁寄りの明るい場所を定位置にしておくと、台風のたびに大移動しなくて済むよ。
<!-- /character-note -->
...
台風のあとに晴れると土の表面はすぐ乾いて見えるけど、鉢の中はまだ雨水でびしょびしょなことが多いよ。表面の色じゃなく、鉢を持ち上げた重さで判断してね。通過後に受け皿の水を捨てた日をアプリの水やり記録に残しておくと、次にいつ水をやるか迷わなくなるよ。
<!-- /character-note -->
