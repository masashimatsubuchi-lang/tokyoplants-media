...
根がびっしり回っていても、真っ白で元気そうならまだ余裕がある証拠。逆に根の色がくすんでいたり弾力がなかったりする場合は、根詰まりと同時に根の状態も傷み始めているサインなので、植え替えの優先度が上がる。
<!-- /character-note -->
...
| 特徴 | 水根（水挿し由来） | 土根（土植え由来） |
|------|-----------------|-----------------|
| 太さ | やや太い | 細く枝分かれしている |
| 根毛の量 | 少ない | 多い（吸収効率が高い） |
| 適応環境 | 常時水中（低酸素） | 乾湿のメリハリ（酸素豊富） |
| 土への耐性 | 低い（移行時に傷みやすい） | 高い |

水根を急に土に移すと、土の環境に適応できず根が傷んでしまうことがあります。

<!-- character-note character="kuro" type="tip" -->
水根は見た目が太く白いことが多いが、土に植えたあとに伸びてくる新しい根は細く枝分かれした質感になる。根を掘り返して確認しなくても、新しく出てくる根の見た目で移行が順調かどうかを判断できる。
<!-- /character-note -->
...
水やりのたびに乾くまでの日数をメモしておくと、そのペースが安定してきたかどうかが分かりやすい。Green Collectionの水やり記録を使えば、移行がうまく進んでいるかを数字で振り返れるよ。
<!-- /character-note -->
