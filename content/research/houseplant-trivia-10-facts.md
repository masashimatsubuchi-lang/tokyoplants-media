...
2013年に学術誌 *The American Naturalist* に発表された研究（クリストファー・ミュア氏によるモデル解析）では、穴があることで、林床特有の不規則な木漏れ日（サンフレック）による光量の変動が抑えられ、結果として植物の成長がより安定することが数理モデルによって示されています。ただし「これが唯一の理由」とは証明されておらず、複数の要因が組み合わさっている可能性が高いとされています。
...
ただし後に複数の研究者が指摘したのは、**実験が密閉チャンバー内での結果**であり、実際の室内空間と条件が大きく異なるという点です。2019年にドレクセル大学のマイケル・ウェアリング氏らが過去30年分の関連研究を分析した論文によれば、「建物の換気システムや窓開けと同程度の空気清浄効果を得るには、1平方メートルあたり100〜1,000鉢の植物が必要」と試算されました。
