...
著名なプラントハンターのひとり、**アンドレ・コニャクス（André Cogniaux）** や **ギュスターヴ・ワリス（Gustav Wallis）** は、コロンビア・エクアドルでフィロデンドロン・アンスリウムの希少種を多数採集しています。このころ採集された種が、現在のコレクターズプランツの原型になっているものも少なくありません。
