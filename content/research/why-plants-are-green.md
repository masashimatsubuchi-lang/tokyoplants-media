...
クロロフィルが吸収するのは主に青と赤の光。育成ライトを選ぶときに「青多め」「赤多め」といったスペック表示を見かけるのは、まさにこの吸収特性に合わせて光合成を効率化しようとしているからだよ。
<!-- /character-note -->
...
2020年にカリフォルニア大学バークレー校のグレアム・フレミングらが *Nature Communications* 誌に発表した研究では、クロロフィルbが緑の光を吸収し、葉の内部深くまで光合成活性を分配する役割を担っている可能性が示されました。緑の光を完全に無駄にするのではなく、葉全体に光を行き渡らせる仕組みの一端を担っているという考え方です。

<!-- character-note character="sandy" type="tip" -->
「光は多ければ多いほど良い」と思われがちだけど、植物にも適正な光量の上限があるんだ。真夏の直射日光で葉が白っぽく傷むのは、この光阻害が起きているサインかもしれないよ。
<!-- /character-note -->
...
一度黄色くなった葉自体は緑には戻らないけれど、原因を取り除けば次に展開する新しい葉は健康に育つよ。下葉だけが黄色いなら寿命による自然な入れ替わりのことも多いから、株全体か一部かで慌てる度合いを変えていいんだ。
<!-- /character-note -->
