...
「距離を詰めていく」って言われても、実際に何cmなのか目測だとズレやすいんだよね。メジャーで測って記録しておくか、アプリの光量チェック機能で設置位置のPPFD目安を確認しながら詰めていくと、葉焼けの手前で止めやすいよ。
<!-- /character-note -->
...
「締まって育つ」効果は葉が入れ替わる中でじわじわ表れてくるものだから、数日で劇的に変わるわけじゃないよ。導入前後の姿を写真で残しておくと、数週間〜数ヶ月後に見比べたときに変化がよく分かるよ。
<!-- /character-note -->
...
スペック表の数字は「一番条件がいい距離での値」であることが多いから、そのまま自分の設置環境に当てはまると思わない方がいいよ。同じライトでも置き方次第でPPFDは大きく変わるんだ。
<!-- /character-note -->
