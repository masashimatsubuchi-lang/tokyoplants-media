---
image: "https://images.unsplash.com/photo-1655151071844-746b090106d2?w=800&q=80"
title: "植物育成ラック・温室 おすすめ5選｜タイプ別レビュー"
...
amazonProducts:
  ...
  - title: "ドウシシャ ルミナス ノワール 4段"
    asin: "B07H9VRZ17"
    note: "耐荷重80kg/段・防錆マットブラック・汎用メタルラック"
  - title: "タカショー ビニール温室 3段 GRH-N02T"
    asin: "B009HI1YBU"
    note: "省スペース3段・保温保湿・コスパ重視"
  - title: "タカショー ビニール温室 4段 GRH-N03T"
    asin: "B009HI3Z1C"
...
1. **耐荷重で選ぶ** — 観葉植物は土と水を含むと想像以上に重い。6号鉢で3〜5kg、8号鉢で5〜10kgになるため、1段あたりの耐荷重が最低でも30kg以上あるラックを選ぶのが安全。メタルラックは製品ラインによって耐荷重の幅が大きく、1段80kg前後のシリーズから250kgクラスの重量級モデルまであるため、購入前に商品ページで必ず耐荷重を確認したい
...
ルミナスやアイリスオーヤマなど、汎用のスチールラックを植物棚として流用するパターン。最大の強みは **頑丈な作り** と **パーツの拡張性** である。ただしルミナスは複数のシリーズを展開しており、耐荷重は製品ラインによって差がある（後述のノワールシリーズは1段80kgが目安）。購入前に商品ページでシリーズごとの耐荷重を確認しておきたい。
...
幅85cmの棚板は6号鉢を横に5〜6個並べられるサイズ感。フレームはスチール製で剛性があり、揺れやぐらつきが少ない。組み立ても工具不要でスムーズ。

注意点として、ルミナスのようなパーツ互換の拡張性はない。上下連結パーツが付属しており2台まで積み重ねる拡張は可能だが、その場合キャスターは使用できず、棚板の単体追加や左右への連結はできない。

**強み**: ライト取付前提の設計、コード取り回し考慮済み、組み立てが容易、2台までの積み重ね拡張に対応

**注意点**: 棚板単体の追加や左右連結は不可、汎用メタルラックより高価
...
スペック面では1段あたりの耐荷重が80kg。8号鉢（1鉢5〜10kg程度）を並べる場合は、1段あたりの合計重量が80kgを超えないよう本数に注意したい。棚板はワイヤーメッシュで通気性が高く、水やり後の蒸れが起きにくい。棚板の高さは2.5cm刻みで調整可能で、植物の背丈に合わせて段の間隔を変えられる。
...
**強み**: 耐荷重80kg/段、マットブラックで見た目よし、パーツ拡張が豊富、高さ調整自在
...
<img src="https://m.media-amazon.com/images/P/B07H9VRZ17.01._SL160_.jpg" alt="" style="width:80px;height:80px;object-fit:contain;border-radius:0.5rem;flex-shrink:0;background:#fffbeb" loading="lazy" />
<div><p style="margin:0;font-weight:700;font-size:15px;color:#92400e">ルミナス メタルラック（マットブラック）</p><p style="margin:4px 0 0;font-size:12px;color:#78716c">Amazon で見る →</p></div>
</a>
</div>
...
<img src="https://m.media-amazon.com/images/P/B009HI1YBU.01._SL160_.jpg" alt="" style="width:80px;height:80px;object-fit:contain;border-radius:0.5rem;flex-shrink:0;background:#fffbeb" loading="lazy" />
<div><p style="margin:0;font-weight:700;font-size:15px;color:#92400e">ビニール温室（3段）</p><p style="margin:4px 0 0;font-size:12px;color:#78716c">Amazon で見る →</p></div>
</a>
</div>
...
<img src="https://m.media-amazon.com/images/P/B009HI3Z1C.01._SL160_.jpg" alt="" style="width:80px;height:80px;object-fit:contain;border-radius:0.5rem;flex-shrink:0;background:#fffbeb" loading="lazy" />
<div><p style="margin:0;font-weight:700;font-size:15px;color:#92400e">ビニール温室（4段）</p><p style="margin:4px 0 0;font-size:12px;color:#78716c">Amazon で見る →</p></div>
</a>
</div>
...
<img src="https://m.media-amazon.com/images/P/B08VHVGHXD.01._SL160_.jpg" alt="" style="width:80px;height:80px;object-fit:contain;border-radius:0.5rem;flex-shrink:0;background:#fffbeb" loading="lazy" />
<div><p style="margin:0;font-weight:700;font-size:15px;color:#92400e">IKEA RUDSTA ガラスキャビネット</p><p style="margin:4px 0 0;font-size:12px;color:#78716c">Amazon で見る →</p></div>
</a>
</div>
...
| 10鉢以上を本格的に棚管理したい | ルミナス ノワール 4段 | 耐荷重80kg/段・パーツ拡張が豊富 |
...
- ラックの導入と合わせて育成ライトを検討する場合は「[植物育成ライト おすすめ5選](/review/plant-light-review)」も参考にしてほしい
