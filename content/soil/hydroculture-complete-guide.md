...
「無機培地には栄養がない」というのは、見方を変えれば「根が余計なものに邪魔されず呼吸に集中できる」ということでもあるよ。土のような有機物の分解が起きない分、根腐れの原因菌も繁殖しにくいんだ。
<!-- /character-note -->
...
<div style="flex:1;background:#e7e5e4"></div>
</div>
<p style="margin:0.4rem 0 0;font-size:12px;color:#57534e">■富士山溶岩石 75%　■島根県産ゼオライト 25%</p>
</div>
...
配合比率を自分で調整したくなったら、まず通気性を担当する素材（溶岩石やパーライト）の割合を減らさないことを意識するといいよ。水質浄化担当の素材だけ増やすと、今度は根が酸欠になりやすくなる。
<!-- /character-note -->
...
「水を張りっぱなしにしない」というルールは、土栽培の「乾いたら水やり」と根っこは同じ考え方だよ。培地が違うだけで、根が求めているのは変わらず「湿ると乾くのメリハリ」なんだ。
<!-- /character-note -->
...
水を足した日をGreen Collectionアプリで記録しておくと、「前回からどれくらい経ったか」が一目でわかって、冬の頻度調整もしやすくなるよ。
<!-- /character-note -->
