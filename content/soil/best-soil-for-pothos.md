...
ポトスの根は「べったり湿った土」より「乾いたり湿ったりを繰り返す土」の方が元気に育つよ。これは着生植物に共通する性質だから、モンステラやフィロデンドロンの土選びでも同じ考え方が使えるよ。
<!-- /character-note -->
...
| ◯ 選ぶべき土 | ✕ 避けるべき土 |
|-------------|---------------|
| 赤玉土・パーライトが含まれている | 花用の培養土（保水性が高すぎる） |
| 「水はけが良い」と記載がある | ピートモス主体の土（乾くと水を弾く） |
| 粒状の素材が主体 | 重い土（吊り鉢に不向き） |
...
<p style="margin:0 0 0.75rem;font-weight:700;color:#44403c;font-size:14px">基本配合と軽量配合の比率の違い</p>
<div style="margin-bottom:0.75rem">
<p style="margin:0 0 4px;font-size:12px;color:#57534e">基本配合　赤玉土5：パーライト3：バーク堆肥2</p>
...
<div>
<p style="margin:0 0 4px;font-size:12px;color:#57534e">吊り鉢用（軽量配合）　赤玉土3：パーライト4：バーミキュライト2：くん炭1</p>
<div style="display:flex;height:20px;border-radius:0.375rem;overflow:hidden">
...
<p style="margin:0.75rem 0 0;font-size:11px;color:#57534e"><span style="color:#b45309">■</span>赤玉土　<span style="color:#cbd5e1">■</span>パーライト　<span style="color:#78716c">■</span>バーク堆肥　<span style="color:#eab308">■</span>バーミキュライト　<span style="color:#292524">■</span>くん炭</p>
<p style="margin:0.5rem 0 0;font-size:11px;color:#a8a29e">※軽量配合は赤玉土を減らし、軽いパーライト・バーミキュライトの比率を上げることで鉢全体を軽くしています。</p>
</div>

パーライトの割合を増やすと軽くなります。吊り鉢やハンギングで育てる場合は、軽量配合がおすすめです。

<!-- comparison-summary
  title="基本配合と軽量配合、どちらを選ぶか"
  leftLabel="基本配合"
  leftTagline="棚や床に置いて育てる場合"
  leftItems="赤玉土（小粒）5：パーライト3：バーク堆肥2|バーク堆肥が適度な保水性を受け持つ|重さがある分、株が安定しやすい|標準的な鉢植えならこれで十分"
  rightLabel="吊り鉢用（軽量配合）"
  rightTagline="ハンギング・高い位置に飾る場合"
  rightItems="赤玉土（小粒）3：パーライト4：バーミキュライト2：くん炭1|赤玉土を減らし軽い素材の比率を上げて鉢を軽量化|パーライトが多く水はけがさらに良い|くん炭が根腐れ防止とpH調整を担う"
-->

くん炭の効果・配合の目安は[もみ殻くん炭とは｜効果・使い方・デメリット](/soil/kunzan-for-houseplants)で詳しく解説しています。

<!-- character-note character="kuro" type="tip" -->
赤玉土は使っているうちに崩れて粒が細かくなるから、月日が経つと軽量配合でも徐々に重くなることがあるよ。1〜2年経ったら配合が崩れていないか、鉢を持ち上げて確認する習慣をつけるといいかも。
<!-- /character-note -->
...
| ステップ | やること | そうする理由 |
|---------|---------|------------|
| 1 | 根が5cm以上伸びているか確認 | 短いと土に定着しにくい |
| 2 | 3〜4号の小さい鉢から始める | 大きい鉢だと吸いきれない水分が土に残り過湿になる |
| 3 | 排水性の高い土を使う | 水耕の根が呼吸しやすい環境を作る |
| 4 | 最初の1週間は腰水（受け皿に1〜2cm） | 急に乾燥した環境に置くと根が水を吸えなくなる |

ポイントは、水に慣れた根を「いきなり乾いた土」に置かないこと。ステップ4の腰水は、水耕栽培の根が急な乾燥で水分を吸えなくなるのを防ぐための緩衝期間で、1週間経ったら通常の水やり（土が乾いてから与える）に切り替えます。土は前述の基本配合（赤玉土5：パーライト3：バーク堆肥2）と同じく排水性重視で問題ありません。

<!-- character-note character="shadee" type="tip" -->
腰水をやめるタイミングは、指で土に触れて「湿り気が均一になってきたか」で判断するとわかりやすいよ。水やりした日をアプリの記録に残しておくと、次にいつ通常管理へ切り替えたか振り返りやすいね。
<!-- /character-note -->
