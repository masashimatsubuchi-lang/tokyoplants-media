...
title: 観葉植物の土 完全ガイド｜土の設計思想とトラブル解決（虫・カビ・根腐れ）
description: 観葉植物の土の基礎知識（通気性・排水性・保水性・保肥性）、配合の考え方、植え替え時の判断、虫・カビ・根腐れ・再利用などのトラブル対策を1本に集約。用土をどれにするか診断したい場合は「観葉植物の用土選び方診断ガイド」へ、植えた後の不調・トラブル対応は本記事へ。
date: '2026-02-17'
category: soil
tags:
  - 土
...
なお、「今使っている土をどう選べばいいか」を条件別にすぐ診断したい場合は、[観葉植物の用土選び方｜診断ガイド](/soil/houseplant-soil-selection-guide)から入ると最短です。本記事は、選んだ土を使い始めてからの設計思想の理解や、虫・カビ・根腐れといった不調が出たときのトラブル解決に重点を置いています。
...
さらに、室内管理では「清潔性（虫・カビが発生しにくい状態）」を追加要件として扱うと安定します。

置き場所や水やり頻度から「自分にはどの用土が合うか」を条件別にすぐ判断したい場合は、[観葉植物の用土選び方｜診断ガイド](/soil/houseplant-soil-selection-guide)の診断表を使ってください。本記事ではその先、土の設計思想の理解とトラブル対応を掘り下げます。
...
| 軸 | 何を見るか | 強すぎる場合 | 弱すぎる場合 |
|----|-----------|------------|------------|
| 通気性 | 根が呼吸しやすいか | ― | 根腐れしやすい |
| 排水性 | 過剰水分を逃がせるか | 乾きすぎる | 過湿・根腐れ |
| 保水性 | 次回の水やりまで保てるか | 過湿になりやすい | すぐ乾く |
| 保肥性 | 肥料成分を保持できるか | ― | 肥料が流れやすい |

<!-- character-note character="kuro" type="point" -->
この4軸は同時に数値化できるものではないため、感覚だけで判断するのは難しい。まずは代表的な市販品をベースにして、そこからの「変化」で判断するほうが再現性が上がる。
<!-- /character-note -->
...
### 1〜2. 置き場所と水やり運用の条件を固定する

土を決める前に、まず環境（光・風・温度・湿度・鉢の種類）と水やり運用（毎日観察できるか、週1回中心かなど）を固定します。この2条件を先に言語化しないまま土を変えると、改善しても再現できません。条件ごとの具体的な診断表とチェックリストは[観葉植物の用土選び方｜診断ガイド](/soil/houseplant-soil-selection-guide)にまとめているので、ここでは重複を避けて先に進みます。
...
根の色は乾いた状態と湿った状態で見え方が変わるため、判断に迷ったら軽く霧吹きで湿らせてから確認すると、健康な根かどうか見分けやすくなる。
<!-- /character-note -->
...
重さで判断する場合は、水やり直後（水を含んだ状態）と、明らかに乾いた状態の重さを一度両方持ってみて「体に覚えさせる」のが早い。慣れると持った瞬間に分かるようになる。
<!-- /character-note -->
...
<!-- character-note character="kuro" type="tip" -->
土を変えた日付や配合を記録しておくと、「前回はどうだったか」を思い出しやすくなる。Green Collectionの植え替え記録を使えば、土の配合メモも残しておけるよ。
<!-- /character-note -->

この順序で運用すれば、土選びは「勘」ではなく「設計」に変わります。本記事をハブとして必要箇所を深掘りし、各詳細記事を往復しながら改善を進めてください。条件別にどの用土を選ぶべきかを先に診断したい場合は、[観葉植物の用土選び方｜診断ガイド](/soil/houseplant-soil-selection-guide)もあわせてご覧ください。
