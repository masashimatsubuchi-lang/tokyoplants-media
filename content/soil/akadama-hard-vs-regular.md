---
image: "https://images.pexels.com/photos/216674/pexels-photo-216674.jpeg?auto=compress&cs=tinysrgb&w=1200"
...
| 比較項目 | 硬質赤玉土 | 普通赤玉土 |
|---|---|---|
| 崩れやすさ | 焼成・硬化度合いが高く崩れにくい | 潅水や根圧の繰り返しで微塵化しやすい |
| 排水性の持続 | 粒が長期間維持され排水性・通気性が安定 | 時間経過とともに粒が崩れ排水性が低下しやすい |
| 差が表れる時期 | 3か月後・6か月後も粒形を維持しやすい | 3か月後・6か月後には崩れ（へたり）が目立ちやすい |
| 価格 | 普通赤玉土よりやや高め | 初期コストを抑えやすい |
| 再利用のしやすさ | ふるい処理後に再配合しやすい | 崩れが進むと再利用効率が落ちる |
| 向いている用途 | 1年以上同じ鉢で育てる長期栽培、過湿に弱い植物（パキラ・サンスベリア等） | 初期コストを下げたい短期利用、保水をやや持たせたい環境での一部混合 |

<!-- character-note character="kuro" type="point" -->
崩れやすさの違いは、粒の焼き方（焼成度合い）の差によるもの。陶器と同じで、しっかり焼き締められた粒ほど吸水と乾燥を繰り返しても形状を保ちやすい。
<!-- /character-note -->
...
根詰まりや土の劣化が心配なときは、植え替え時に鉢底の土をひとつまみ取って指でこすってみるとよい。サラサラと粒が残っていれば通気性はまだ十分、泥のように潰れるなら土の寿命のサインだ。
<!-- /character-note -->
...
<div style="flex:5;background:#b45309" title="硬質赤玉土 5"></div>
<div style="flex:3;background:#78716c" title="ココ系・バーク系 3"></div>
<div style="flex:2;background:#d6d3d1" title="軽石・パーライト 2"></div>
</div>
...
<div style="display:flex;height:20px;border-radius:0.375rem;overflow:hidden">
<div style="flex:4;background:#b45309" title="硬質赤玉土 4"></div>
<div style="flex:3;background:#d6d3d1" title="軽石 3"></div>
<div style="flex:3;background:#78716c" title="バーク・ココ 3"></div>
</div>
...
<div style="display:flex;height:20px;border-radius:0.375rem;overflow:hidden">
<div style="flex:4;background:#b45309" title="硬質赤玉土 4"></div>
<div style="flex:2;background:#f59e0b" title="普通赤玉土 2"></div>
<div style="flex:2;background:#65a30d" title="有機質 2"></div>
<div style="flex:2;background:#a8a29e" title="通気材 2"></div>
</div>
...
<!-- character-note character="kuro" type="tip" -->
植え替えた日付と使った配合を記録しておくと、次に植え替えるときの比較材料になる。Green Collectionの植え替え記録に配合メモを残しておくと、土を変えた効果を後から振り返りやすいよ。
<!-- /character-note -->
...
<p style="margin:6px 0 0;font-size:14px;color:#57534e;line-height:1.8">硬質か普通かで迷ったら、まず今使っている土を植え替え時に手で崩してみてください。粉状の部分がどのくらい出るかで、次に選ぶべきタイプの判断材料になります。</p>
</div>
