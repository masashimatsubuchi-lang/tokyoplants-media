...
<p style="margin:0 0 4px;font-size:12px;color:#57534e">基本配合（成株・標準サイズの鉢）　観葉植物用培養土8：パーライト2</p>
<div style="display:flex;height:20px;border-radius:0.375rem;overflow:hidden">
<div style="flex:8;background:#57534e"></div>
<div style="flex:2;background:#cbd5e1"></div>
</div>
</div>
<div>
<p style="margin:0 0 4px;font-size:12px;color:#57534e">子株の植え付け用　パーライト4：観葉植物用培養土4：ココチップ2</p>
<div style="display:flex;height:20px;border-radius:0.375rem;overflow:hidden">
...
<p style="margin:0.75rem 0 0;font-size:11px;color:#57534e"><span style="color:#57534e">■</span>観葉植物用培養土　<span style="color:#cbd5e1">■</span>パーライト　<span style="color:#ca8a04">■</span>ココチップ</p>
</div>
...
<p style="margin:6px 0 0;font-size:14px;color:#57534e;line-height:1.8">子株用の配合はパーライトの割合を大幅に増やし、さらにココチップを加えて通気性を高めています。根が少ないうちは「乾きやすさ」を優先する配合にしておくと管理がしやすくなります。</p>
</div>
