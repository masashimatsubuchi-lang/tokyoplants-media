...
<!-- comparison-summary
  ...
  leftLabel="ねこチップ"
  leftTagline="素材として優秀"
  leftItems="土の配合を自分で試行錯誤したい人|ハイドロカルチャーや底面給水を実践している人|シンプルな2素材からベースを作りたい人"
  rightLabel="I'm original SOIL"
  rightTagline="仕上がった配合土として優秀"
  rightItems="植え替えをすぐ終わらせたい人|肥料管理の手間を減らしたい人|室内を清潔に保ちたい人"
-->
...
<mark>ねこチップが注目される最大の理由は、**清潔さ**と**水はけの良さ**です。</mark>原料に含まれるココチップは十分に洗浄・乾燥処理されたヤシガラ由来の資材であり、未熟な腐葉土やピートモスのように虫の卵や幼虫の餌になりやすい未分解の有機物をほとんど含まないとされます。加えて日向石が通気性・排水性を高めるため、多湿を好むコバエなどの害虫が繁殖しにくい環境になりやすいと考えられています。こうした理由から、室内で植物を育てるうえでの悩みを軽減してくれる存在として支持されています。また、粒が均一で見た目が整っているため、インテリアとしての植物に合わせたときの清潔感ある見た目も支持されています。

<!-- character-note character="kuro" type="point" -->
根は水だけでなく酸素も吸って生きているよ。虫が出にくいという話題性の裏側で、実は「粒の隙間が多い＝根が呼吸しやすい」という点こそ、根腐れを防ぐ本質的なメリットなんだ。
<!-- /character-note -->
...
水切れのサインは、土を触るより先に鉢の重さでわかることが多いよ。水をあげた直後の重さを覚えておくと、「そろそろ乾いてきたかも」が指先より早く感じ取れるようになるはず。
<!-- /character-note -->
...
配合レシピは数字どおりに固定しなくて大丈夫だよ。置き場所の風通しや鉢の素材で乾くスピードは変わるから、最初の1ヶ月は土の乾き具合を見ながら微調整していくのがコツ。
<!-- /character-note -->
...
|---|---|---|
| 素材 | ヤシガラ（ココチップ）＋日向石の2種 | 6種の天然素材（ヤシ繊維30%・日向石20%・蘭の発酵樹皮20%・ミミズ堆肥10%・ピートモス10%・パーライト10%） |
| 栄養分 | ごくわずか（要追肥） | ミミズ堆肥による元肥を配合済み |
| 水はけ | ◎ | ◎ |
| 保水性 | △（乾きが早い） | ○（水やり頻度を抑えやすい） |
| 虫の発生 | ほぼなし | 少ない |
| 使い方 | 単体では配合が必要なことが多い | 開封してそのまま使える |
| 容量と価格 | 5L ¥2,490／10L ¥4,300<br>（**約430〜500円/L**） | 2L ¥1,200／10L ¥4,800<br>（**480〜600円/L**、10Lが割安） |
| パッケージ | 袋（開封後は移し替えが必要なことも） | **ジップ付き**。使いたい分だけ出して、そのまま保管できる |
| 化学肥料 | 不使用 | 不使用 |
| 肥料管理 | 植え付け直後から追肥が必要 | 植え替え直後の追肥は不要 |
| 向いている人 | 配合を自分で組み立てたい人 | 迷わずそのまま使いたい人 |
...
用土は一度に使い切ることのほうが少なく、開封後の保管に困りがちです。I'm original SOILはジップ付きのパッケージなので、**必要な分だけ出して残りはそのまま袋で保管**できます。別容器への移し替えや、口を折ってテープで留めるといった手間がいりません。

サイズは**2L（¥1,200）と10L（¥4,800）の2種類**。まず試すなら2L、複数鉢を植え替えるなら1Lあたりが割安になる10Lが目安です。粒は小〜中粒でそろえてあるため、このひと袋でサイズの違う鉢を通して使えます。

<!-- callout type="tip" title="どちらのサイズを買うか" -->
6号鉢1つの植え替えでおよそ2〜3Lが目安です。**1鉢だけなら2L、2鉢以上または今後も植え替える予定があるなら10L**が結果的に安くつきます（2L換算で¥600/L、10Lなら¥480/L）。
<!-- /callout -->
...
つまり「ねこチップ＝虫ゼロ保証」ではなく、「虫の餌になりやすい未分解の有機質を減らし、通気性を高めることで発生リスクを下げる」というのが正確な理解です。土に虫が湧く仕組みと対策については[観葉植物の土に虫が湧く原因と対策](/soil/bugs-in-houseplant-soil)で詳しく解説しています。
...
ねこチップ自体は乾燥・処理済みでカビの栄養源になりにくくても、使用中に鉢の表面へ枯れ葉・花がら・肥料の残渣が堆積すると、その有機物を栄養源にカビが生えることがあります。これは[観葉植物の土にカビが生える原因と対策](/soil/mold-on-houseplant-soil)で解説している「過湿＋有機質＋通気不足」の3条件が揃うことで起こる一般的なメカニズムで、ねこチップに限らずどの用土でも起こり得ます。
