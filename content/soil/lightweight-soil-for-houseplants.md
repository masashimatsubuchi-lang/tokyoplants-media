...
軽さだけを求めてパーライトや軽石ばかりにすると、今度は肥料や水分がすぐ抜けてしまう土になりがち。軽量化と保肥力はトレードオフの関係にあることを覚えておくと、配合のバランスを取りやすいよ。
<!-- /character-note -->
...
| 商品 | タイプ | 軽量化の目安 | 単体使用 | 価格帯 |
|---|---|---|---|---|
| プロトリーフ 軽い観葉植物の土 | 培養土（軽量化済み） | 通常比 約40% | 可 | 中 |
| パーライト | 土壌改良材 | 混合で大幅減 | 不可（混ぜ用） | 低 |
| 日向土 小粒 | 無機培地 | 混合で大幅減 | 可（排水目的） | 低 |
| スーパーミックスA | 培養土（ヤシ繊維ベース） | 中程度 | 可 | 中 |
| I'm original SOIL（tokyoplantsプレミアム培養土） | 観葉植物専用ブレンド | 中〜高 | 可 | 低〜中 |
...
大鉢の土を替えたら、配合と使用量をメモしておくのがおすすめ。Green Collectionの植え替え記録に残しておけば、次の植え替え時に同じ配合を再現しやすくなるよ。
<!-- /character-note -->
...
鉢を持ち上げて「軽くなった」と感じるタイミングを覚えておくと、土を見なくても水切れのサインがわかるようになるよ。慣れると指で土を触るより早く判断できる。
<!-- /character-note -->
