    ...
    <header className="border-b border-gray-100 bg-white">
      <div className="mx-auto max-w-5xl px-4 py-5 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 text-[13px]">
          ...
          <HeaderAppLink className="rounded-full border border-emerald-700 px-4 py-1.5 text-xs font-semibold text-emerald-700 hover:bg-emerald-50 transition-colors" />
          <a
        ...
        <div className="md:hidden flex items-center gap-2">
          ...
          <HeaderAppLink className="rounded-full border border-emerald-700 px-3 py-2.5 text-xs font-semibold text-emerald-700" />
          <a
            href="https://www.tokyoplants.com"
            target="_blank"
            rel="noopener noreferrer"
