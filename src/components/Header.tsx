    ...
    <header className="border-b border-gray-100 bg-white">
      <div className="mx-auto max-w-5xl px-4 py-5 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 text-[13px]">
          ...
          {/* アプリ紹介LPへ。App Storeへ直接リンクしないこと（アプリ内ブラウザで
              白画面になる。理由はAppStoreButtonのコメント参照）。 */}
          <Link
            href="/app?ch=header"
            className="rounded-full border border-emerald-700 px-4 py-1.5 text-xs font-semibold text-emerald-700 hover:bg-emerald-50 transition-colors"
          >
            App
          </Link>
          <a
        ...
        <div className="md:hidden flex items-center gap-2">
          ...
          <Link
            href="/search"
            className="rounded-full border border-gray-200 px-3 py-2.5 text-xs font-semibold text-gray-700"
          >
            検索
          </Link>
          <Link
            href="/app?ch=header"
            className="rounded-full border border-emerald-700 px-3 py-2.5 text-xs font-semibold text-emerald-700"
          >
            App
          </Link>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="rounded-full bg-emerald-700 px-3 py-2.5 text-xs font-semibold text-white hover:bg-emerald-800 transition-colors"
          >
            SHOP
          </a>
        </div>
