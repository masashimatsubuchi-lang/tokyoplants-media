...
export const AUTHORS: Record<string, Author> = {
  "masashi-matsubuchi": {
    ...
    bio: "東京・世田谷を拠点とする希少観葉植物専門店「tokyoplants」オーナー。自ら海外へ足を運んで一点ずつ厳選した株を買い付け、年間800株以上を自身の手で育てて販売しています。",
    bioLong:
      "東京都世田谷区を拠点に、希少な観葉植物を専門に扱う「tokyoplants」を運営しています。自ら海外まで足を運び、現地で一点ずつ状態を確かめながら株を買い付けるスタイルを続けてきました。仕入れた株はすぐに販売するのではなく、自身の手で育成し、状態を見極めた上で送り出す——そうして毎年800株を超える観葉植物を育て、販売しています。アンスリウムやモンステラ、アロカシアといった熱帯植物を中心に、日々の栽培・検証で得た知見をもとに、育て方や用土選びの情報を発信しています。アロイド植物の根の性質に合わせて、培養土「I'm original SOIL」や無機培地「HYDRO MINERAL」もオリジナルで開発しました。また、自身の栽培経験・専門知識を反映した育成アドバイスが得られる植物管理アプリ「Green Collection」の開発にも携わっています。",
